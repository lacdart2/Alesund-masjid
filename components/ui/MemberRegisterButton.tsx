...
import { IconUserPlus, IconUsers, IconX, IconTrash } from '@/components/ui/Icons'
...
const LABELS = {
    no: {
        ...
        stepOf: 'av',
        email: 'E-post',
        consent: 'Jeg godtar at Ålesund Moske lagrer mine personopplysninger i henhold til personvernregelverket (GDPR).'
    },
    en: {
        btn: 'Become a member',
        close: 'Close',
        ...
        stepOf: 'of',
        email: 'Email',
        consent: 'I agree that Ålesund Moske stores my personal data in accordance with GDPR.'
    },
    ar: {
        btn: 'سجّل عضويتك',
        close: 'إغلاق',
        ...
        consent: 'أوافق على أن مسجد أولسند يخزن بياناتي الشخصية وفقاً للوائح GDPR.'
    },
}
...
export default function MemberRegisterButton() {
    ...
    const validateStep4 = () => signatureName.trim() && declared && consent
                                ...
                                <div style={{
                                    ...
                                    <label style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', cursor: 'pointer' }}>
                                        <input
                                            ...
                                            style={{ accentColor: '#22a052', width: '16px', height: '16px', flexShrink: 0, marginTop: '2px' }}
                                        />
                                        <span style={{ fontSize: '13px', color: '#607080', lineHeight: 1.5 }}>
                                            {t.consent}{' '}
                                            <a href="/personvern" target="_blank" style={{ color: '#22a052', textDecoration: 'underline' }}>
                                                {lang === 'no' ? 'Les mer' : lang === 'en' ? 'Read more' : 'اقرأ المزيد'}
                                            </a>
                                        </span>
                                    </label>
                                </div>
